...
<?php include_once $TPL_PATHS->getServerRoot() . '/_lang/' . $TPL_LANG->getLanguage() . "/navigation.php"; ?>
				<hr />
...
<?php // Hier wird der eigentliche Content eingebaut:
 ...
 <!-- foot -->
 		<tr class="rahmenhoehe">
			...
			<td class="rahmen_bb"><?php include_once $TPL_PATHS->getServerRoot() . "_lang/langSelector.php"; ?></td>
