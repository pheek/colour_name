...
ALTER  DATABASE             `farbnamen` DEFAULT CHARACTER SET 'utf8' DEFAULT COLLATE 'utf8_general_ci';
USE                         `farbnamen`;
...
CREATE TABLE `begriff` (
	`ID`      tinyint NOT NULL
,	`Kuerzel` char(6) COLLATE 'utf8_unicode_ci' NOT NULL COMMENT 'LCD, w, m, f_bl, etc.'
, PRIMARY KEY(`ID`)
) COMMENT='Sprachunabhängige Begriffe i. d. r. englisches Kuerzel';

--
-- Daten für Tabelle `begriff`
--

INSERT INTO `begriff` (`ID`, `Kuerzel`) VALUES
(1, 'LCD'    ),
(2, 'CRT'    ),
(3, 'LED'    ),
(4, 'AMOLED' ),
...
--
-- Tabellenstruktur für Tabelle `farbnamen`
--

CREATE TABLE `farbnamen` (
	`ID`   int                            NOT NULL AUTO_INCREMENT
,	`Name` text COLLATE 'utf8_unicode_ci' NOT NULL COMMENT 'Name der Farbe'
, PRIMARY KEY (`ID`)
) COMMENT='Namen der Farben, die in der Tabelle rgb auf';

--
-- Demodaten für Tabelle `farbnamen`
--

INSERT INTO `farbnamen` (`ID`, `Name`) VALUES
(1, 'cyan'),
(2, 'mandarine');
...
--
-- Tabellenstruktur für Tabelle `ipV4`
--
...
--
-- Demodaten für Tabelle `ipV4`
--

INSERT INTO `ipV4` (`ID`, `v4Int`) VALUES
(1, 1426219562),
(2, 1414157270);
...
--
-- Sort-Order der Medien
--

INSERT INTO `medium` (`ID`, `F_begriff`, `sortOrder`) VALUES
(1, 1, 5),
(2, 2, 15),
(3, 3, 20),
(4, 4, 25),
...
--
-- Tabellenstruktur für Tabelle `netzhaut`
--
...
--
-- Daten für Tabelle `netzhaut`
--

INSERT INTO `netzhaut` (`ID`, `F_begriff`, `sortOrder`) VALUES
(1, 11, 5),
(2, 12, 10),
(3, 13, 15),
(4, 14, 20),
...
--
-- Tabellenstruktur für Tabelle `rgb`
--
...
--
-- Daten für Tabelle `rgb`
--

INSERT INTO `rgb` (`ID`, `R`, `G`, `B`) VALUES
(1, 37, 207, 230),
(2, 255, 207, 56);
...
CREATE TABLE `sprache` (
	`ID`        varchar(3) COLLATE utf8_unicode_ci NOT NULL COMMENT 'en, de, fr, it, es, ...'
,	`Orig_Name` text       COLLATE utf8_unicode_ci NOT NULL COMMENT 'Sprachname in der eigenen Sprache: english, deusch, italiano, ...'
, PRIMARY KEY(`ID`)
...
INSERT INTO `sprache` (`ID`, `Orig_Name`) VALUES
('af', 'Afrikaans'),
('as', 'অসমীয়া'),
('ast', 'Asturianu'),
('be', 'беларуская'),
...
CREATE TABLE `text` (
	`ID`        int        NOT NULL AUTO_INCREMENT
,	`F_sprache` varchar(3) COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `text` (`F_sprache`, `F_begriff`, `Text`) VALUES
...
--
-- Tabellenstruktur für Tabelle `nomination`
--
...
--
-- Daten für Tabelle `nomination`
--

INSERT INTO `nomination` (`ID`, `F_rgb`, `F_farbnamen`, `F_netzhaut`, `F_medium`, `F_ipV4`, `Zeit`, `F_sprache`) VALUES
